...
This is a Smart Contact Manager project. where user can register and login to maintain their contacts. i have used spring-security for authentication. User can add/update/delete and view contact profiles. This application has been made using springboot, thymeleaf, spring-data-jpa MySQL, spring security, validation, Devtools.
