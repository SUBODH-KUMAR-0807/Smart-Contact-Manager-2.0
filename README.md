...
This is a Smart Contact Manager project. where one could register and login to maintain their contacts.i have used spring -security for authentication. User can add/update/delete and view contact profile. This application has been made using springboot, thymeleaf, data-jpa, hibernate, MySQL, spring security, validation, Devtools.
